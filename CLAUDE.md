...
| `packages/cli/`               | `bna-ui` (published)        | `npx bna-ui init\|convex\|add`                                            |
| `packages/starters/`          | `@bna-ui/starters`          | Scaffolds for `init` and `convex`                                         |
...
`init` and `convex` scaffolds stay **bundled** in the npm tarball — they must
