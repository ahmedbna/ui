// registry/demo/toast-example.tsx
import { Text } from '@/components/ui/text';
import { View } from '@/components/ui/view';
import { ToastActions } from '@/docs/examples/toast/toast-actions';
import { ToastCompact } from '@/docs/examples/toast/toast-compact';
import { ToastDemo } from '@/docs/examples/toast/toast-demo';
import { ToastDuration } from '@/docs/examples/toast/toast-duration';
import { ToastMultiple } from '@/docs/examples/toast/toast-multiple';
import { ToastVariants } from '@/docs/examples/toast/toast-variants';
