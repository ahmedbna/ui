...
import { AudioPlayerAutoplay } from '@/docs/examples/audio-player/audio-player-autoplay';
import { AudioPlayerDemo } from '@/docs/examples/audio-player/audio-player-demo';
import { AudioPlayerMinimal } from '@/docs/examples/audio-player/audio-player-minimal';
import { AudioPlayerProgress } from '@/docs/examples/audio-player/audio-player-progress';
import { AudioPlayerStyled } from '@/docs/examples/audio-player/audio-player-styled';
import { AudioPlayerWaveform } from '@/docs/examples/audio-player/audio-player-waveform';
import { AudioPlayerMusic } from '../examples/audio-player/audio-player-music';
