// registry/demo/carousel-example.tsx
import { Text } from '@/components/ui/text';
import { View } from '@/components/ui/view';
import { CarouselArrows } from '@/docs/examples/carousel/carousel-arrows';
import { CarouselCards } from '@/docs/examples/carousel/carousel-cards';
import { CarouselCustomWidth } from '@/docs/examples/carousel/carousel-custom-width';
import { CarouselDemo } from '@/docs/examples/carousel/carousel-demo';
import { CarouselImages } from '@/docs/examples/carousel/carousel-images';
import { CarouselManual } from '@/docs/examples/carousel/carousel-manual';
import { CarouselNoIndicators } from '@/docs/examples/carousel/carousel-no-indicators';
