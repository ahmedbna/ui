...
import { AudioRecorderCallbacks } from '@/docs/examples/audio-recorder/audio-recorder-callbacks';
import { AudioRecorderCloud } from '@/docs/examples/audio-recorder/audio-recorder-cloud';
import { AudioRecorderDemo } from '@/docs/examples/audio-recorder/audio-recorder-demo';
import { AudioRecorderHQ } from '@/docs/examples/audio-recorder/audio-recorder-hq';
import { AudioRecorderInterview } from '@/docs/examples/audio-recorder/audio-recorder-interview';
import { AudioRecorderMinimal } from '@/docs/examples/audio-recorder/audio-recorder-minimal';
import { AudioRecorderStyled } from '@/docs/examples/audio-recorder/audio-recorder-styled';
import { AudioRecorderVoice } from '@/docs/examples/audio-recorder/audio-recorder-voice';
