...
import { AudioWaveformCompact } from '@/docs/examples/audio-waveform/audio-waveform-compact';
import { AudioWaveformDemo } from '@/docs/examples/audio-waveform/audio-waveform-demo';
import { AudioWaveformInteractive } from '@/docs/examples/audio-waveform/audio-waveform-interactive';
import { AudioWaveformRealtime } from '@/docs/examples/audio-waveform/audio-waveform-realtime';
import { AudioWaveformRecording } from '@/docs/examples/audio-waveform/audio-waveform-recording';
import { AudioWaveformStyled } from '@/docs/examples/audio-waveform/audio-waveform-styled';
