/**
 * The BNA UI registry, as an MCP server.
 *
 ...
 *
 * This lives outside the `bna-ui` package because the MCP SDK pulls in express,
 * hono, ajv, cors and jose for HTTP and SSE transports this server never uses —
 * 93 packages and 24 MB, which every `npx bna-ui add` was paying for. Only
 * `StdioServerTransport` is used here.
 */
