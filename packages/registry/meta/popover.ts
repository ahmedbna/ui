...
export const popoverMeta: ComponentMeta = {
  ...
  "types": [
    {
      "name": "Popover",
      "description": "The root component that manages the popover state and provides context.",
      "props": [
        {
          "name": "children",
          "type": "ReactNode",
    ...
    {
      "name": "PopoverContent",
      "description": "The container for the popover content with positioning logic.",
      "props": [
        {
          "name": "children",
          "type": "ReactNode",
