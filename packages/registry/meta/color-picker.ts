...
export const colorPickerMeta: ComponentMeta = {
  "name": "color-picker",
  "usage": {
    "import": "import { ColorPicker, ColorSwatch } from '@/components/ui/color-picker';",
    "snippet": "<ColorPicker\n  value='#ff0000'\n  onColorChange={(color) => console.log('Color changed:', color)}\n  onColorSelect={(color) => console.log('Color selected:', color)}\n/>"
  },
  "types": [
    {
      "name": "ColorPicker",
      "description": "The main color picker component that displays a swatch and opens a modal for color selection.",
      "props": [
        {
          "name": "value",
          "type": "string",
        ...
        },
        {
          ...
          "description": "Callback fired when the color changes during selection."
        },
        {
          "name": "onColorSelect",
          "type": "(color: string) => void",
    ...
    {
      "name": "ColorSwatch",
      "description": "A standalone color swatch component that can be used independently.",
      "props": [
        {
          "name": "color",
          "type": "string",
