...
export const cardMeta: ComponentMeta = {
  ...
  "types": [
    ...
    {
      "name": "CardHeader",
      "description": "Container for the card's header content, typically containing title and description.",
      "props": [
        {
          "name": "children",
          "type": "ReactNode",
          "description": "The header content (typically CardTitle/CardDescription)."
        },
        {
          "name": "style",
          "type": "ViewStyle",
    ...
    {
      "name": "CardFooter",
      "description": "Container for the card's footer content, typically containing actions or additional info.",
      "props": [
        {
          "name": "children",
          "type": "ReactNode",
