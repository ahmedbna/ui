...
export const scrollViewMeta: ComponentMeta = {
  ...
  "types": [
    {
      "name": "ScrollView",
      "description": "A wrapper around React Native's ScrollView with enhanced styling capabilities. All other props from React Native's ScrollView are also supported.",
      "props": [
        {
          "name": "style",
          "type": "ViewStyle",
        ...
        },
        {
          ...
          "type": "boolean",
          "default": "`false`",
          "description": "When true, the scroll view's children are arranged horizontally."
        },
        {
        ...
        },
        {
          ...
          "type": "boolean",
          "default": "`true`",
          "description": "When true, the scroll view bounces when it reaches the end."
        },
        {
          "name": "bouncesZoom",
          "type": "boolean",
        ...
        },
        {
          ...
          "type": "boolean",
          "default": "`false`",
          "description": "When true, the scroll view bounces vertically even when content is smaller."
        },
        {
          "name": "alwaysBounceHorizontal",
          "type": "boolean",
          "default": "`false`",
          "description": "When true, the scroll view bounces horizontally even when content is smaller."
        },
        {
          "name": "pagingEnabled",
          "type": "boolean",
        ...
        },
        {
          ...
          "type": "number",
          "description": "Controls how often the scroll event will be fired while scrolling."
        },
        {
          "name": "onScroll",
          "type": "function",
        ...
        },
        {
          "name": "refreshControl",
          "type": "RefreshControl",
          "description": "A RefreshControl component for pull-to-refresh functionality."
        },
        {
  ...
  "accessibility": {
    "summary": "The ScrollView component maintains React Native's built-in accessibility features:",
    "items": [
