...
export const searchbarMeta: ComponentMeta = {
  "name": "searchbar",
  "usage": {
    "import": "import { SearchBar, SearchBarWithSuggestions } from '@/components/ui/searchbar';",
    "snippet": "<SearchBar\n  placeholder='Search for anything...'\n  onSearch={(query) => console.log('Searching for:', query)}\n  loading={false}\n/>"
  },
  "types": [
    {
      "name": "SearchBar",
      "description": "The main search input component with debouncing and customization options. All other `TextInputProps` are also supported.",
      "props": [
        {
          "name": "loading",
          "type": "boolean",
    ...
    },
    {
      ...
      "description": "An enhanced search bar with dropdown suggestions functionality. All `SearchBar` props are also supported.",
      "props": [
        {
          "name": "suggestions",
          "type": "string[]",
