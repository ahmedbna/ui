...
export const iconMeta: ComponentMeta = {
  ...
  "usage": {
    ...
    "snippet": "<Icon name={Heart} size={24} />\n<Icon name={Star} color=\"#FFD700\" />\n<Icon name={Home} lightColor=\"#000\" darkColor=\"#fff\" />"
  },
  "types": [
    {
      "name": "Icon",
      "description": "The main icon component that renders Lucide React Native icons with theming support.",
      "props": [
        {
          "name": "name",
    ...
    {
      "name": "LucideProps",
      "description": "The Icon component accepts all props from Lucide React Native icons:",
      "props": [
        {
          "name": "strokeLinecap",
          "type": "string",
