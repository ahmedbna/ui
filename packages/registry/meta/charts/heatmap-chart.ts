...
export const heatmapChartMeta: ComponentMeta = {
  ...
  "types": [
    {
      "name": "HeatmapChart",
      "description": "A customizable heatmap chart component with smooth animations and flexible color scaling. Perfect for visualizing matrix data, correlation matrices, activity patterns, and any two-dimensional data with intensity values.",
      "props": [
        {
          "name": "data",
  ...
  "accessibility": {
    "summary": "The HeatmapChart component includes several accessibility features:",
    "items": [
