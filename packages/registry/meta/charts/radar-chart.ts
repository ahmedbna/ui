...
export const radarChartMeta: ComponentMeta = {
  ...
  "types": [
    {
      "name": "RadarChart",
      "description": "A customizable radar chart component with smooth animations and flexible styling. Perfect for displaying multi-dimensional data with emphasis on comparison across multiple metrics.",
      "props": [
        {
          "name": "data",
  ...
  "accessibility": {
    "summary": "The RadarChart component includes several accessibility features:",
    "items": [
