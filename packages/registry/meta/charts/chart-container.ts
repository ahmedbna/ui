...
export const chartContainerMeta: ComponentMeta = {
  ...
  "usage": {
    "import": "import { ChartContainer } from '@/components/charts/chart-container';",
    "snippet": "<ChartContainer\n  title='Monthly Revenue'\n  description='Revenue data for the last 6 months'\n>\n  {/* Your chart component goes here */}\n</ChartContainer>"
  },
  "types": [
    {
      "name": "ChartContainer",
      "description": "A container component that provides consistent styling and layout for charts.",
      "props": [
        {
          "name": "title",
          "type": "string",
  ...
  "accessibility": {
    "summary": "The ChartContainer component is built with accessibility in mind:",
    "items": [
