...
export const candlestickChartMeta: ComponentMeta = {
  ...
  "usage": {
    "import": "import { CandlestickChart } from '@/components/charts/candlestick-chart';",
  ...
  "types": [
    {
      ...
      "description": "A customizable candlestick chart component for financial data visualization with smooth animations.",
      "props": [
        {
          "name": "data",
  ...
  "accessibility": {
    "summary": "The CandlestickChart component is built with accessibility in mind:",
    "items": [
