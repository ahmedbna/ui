...
export const pieChartMeta: ComponentMeta = {
  ...
  "types": [
    {
      "name": "PieChart",
      "description": "A customizable pie chart component with smooth animations and flexible styling. Perfect for displaying proportional data with emphasis on parts of a whole.",
      "props": [
        {
          "name": "data",
          "type": "ChartDataPoint[]",
