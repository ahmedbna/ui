...
export const doughnutChartMeta: ComponentMeta = {
  "name": "doughnut-chart",
  "usage": {
    "import": "import { DoughnutChart } from '@/components/charts/doughnut-chart';",
    "snippet": "const data = [\n  { label: 'Sales', value: 120 },\n  { label: 'Marketing', value: 98 },\n  { label: 'Support', value: 86 },\n  { label: 'Development', value: 140 },\n];\n\n<DoughnutChart\n  data={data}\n  config={{\n    height: 300,\n    showLabels: true,\n    animated: true,\n    innerRadius: 0.6,\n  }}\n/>;"
  },
  "types": [
    {
      "name": "DoughnutChart",
      "description": "A customizable doughnut chart component with smooth animations, interactive legends, and flexible styling. Perfect for displaying proportional data with emphasis on part-to-whole relationships.",
      "props": [
        {
          "name": "data",
          "type": "ChartDataPoint[]",
  ...
  "accessibility": {
    "summary": "The DoughnutChart component includes several accessibility features:",
    "items": [
