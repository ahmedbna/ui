...
export const progressRingChartMeta: ComponentMeta = {
  ...
  "usage": {
    "import": "import { ProgressRingChart } from '@/components/charts/progress-ring-chart';",
    "snippet": "<ProgressRingChart\n  progress={75}\n  size={120}\n  strokeWidth={8}\n  config={{\n    animated: true,\n    duration: 1000,\n    gradient: true,\n  }}\n/>"
  },
  "types": [
    {
      "name": "ProgressRingChart",
      "description": "A customizable circular progress ring component with smooth animations and flexible styling. Perfect for displaying progress, completion rates, or any percentage-based data.",
      "props": [
        {
          "name": "progress",
          "type": "number",
  ...
  "accessibility": {
    "summary": "The ProgressRingChart component includes several accessibility features:",
    "items": [
