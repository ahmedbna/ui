...
export const areaChartMeta: ComponentMeta = {
  "name": "area-chart",
  "usage": {
    "import": "import { AreaChart } from '@/components/charts/area-chart';",
    "snippet": "const data = [\n  { x: 'Jan', y: 100, label: 'January' },\n  { x: 'Feb', y: 120, label: 'February' },\n  { x: 'Mar', y: 90, label: 'March' },\n  { x: 'Apr', y: 140, label: 'April' },\n];\n\n<AreaChart\n  data={data}\n  config={{\n    height: 200,\n    showGrid: true,\n    showLabels: true,\n    animated: true,\n  }}\n/>;"
  },
  "types": [
    {
      "name": "AreaChart",
      "description": "A customizable area chart component with gradient fills and smooth animations. Built on top of the LineChart component with gradient enabled by default.",
      "props": [
        {
          "name": "data",
          "type": "ChartDataPoint[]",
    ...
    },
    {
      ...
      "props": [
        ...
        },
        {
          ...
          "type": "boolean",
          "default": "`true`",
          "description": "Whether to show gradient fill (always true for AreaChart)."
        },
        {
          "name": "interactive",
          "type": "boolean",
  ...
  "accessibility": {
    "summary": "The AreaChart component inherits all accessibility features from LineChart:",
    "items": [
