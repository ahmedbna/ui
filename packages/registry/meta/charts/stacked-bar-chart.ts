...
export const stackedBarChartMeta: ComponentMeta = {
  ...
  "usage": {
    "import": "import { StackedBarChart } from '@/components/charts/stacked-bar-chart';",
  ...
  "types": [
    {
      ...
      "description": "A customizable stacked bar chart component with smooth animations and flexible styling. Perfect for displaying multiple data series stacked on top of each other, supporting both vertical and horizontal orientations.",
      "props": [
        {
          "name": "data",
  ...
  "accessibility": {
    "summary": "The StackedBarChart component includes several accessibility features:",
    "items": [
