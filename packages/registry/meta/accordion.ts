...
export const accordionMeta: ComponentMeta = {
  ...
  "usage": {
    ...
    "snippet": "<Accordion type='single' collapsible>\n  <AccordionItem value='item-1'>\n    <AccordionTrigger>Is it accessible?</AccordionTrigger>\n    <AccordionContent>\n      Yes. It adheres to the WAI-ARIA design pattern.\n    </AccordionContent>\n  </AccordionItem>\n</Accordion>"
  },
  "types": [
    {
      "name": "Accordion",
      ...
      "props": [
        ...
        },
        {
          "name": "value",
          "type": "string | string[]",
          "description": "The controlled value of the item to expand when `type` is `\"single\"` or the controlled values of the items to expand when `type` is `\"multiple\"`."
        },
        {
          "name": "defaultValue",
          "type": "string | string[]",
          "description": "The value of the item to expand when initially rendered when `type` is `\"single\"` or the values of the items to expand when initially rendered when `type` is `\"multiple\"`."
        },
        {
          "name": "onValueChange",
