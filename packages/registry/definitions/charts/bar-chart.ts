// definitions/charts/bar-chart.ts
...
export const barChartRegistry = {
  ...
  'bar-chart': {
    ...
    files: [
      {
        type: 'registry:ui',
        path: 'src/components/charts/bar-chart.tsx',
  ...
  'bar-chart-demo': {
    ...
    files: [
      {
        type: 'registry:example',
        path: 'src/demo/charts/bar-chart/bar-chart-demo.tsx',
  ...
  'bar-chart-sample': {
    ...
    files: [
      {
        type: 'registry:example',
        path: 'src/demo/charts/bar-chart/bar-chart-sample.tsx',
  ...
  'bar-chart-minimal': {
    ...
    files: [
      {
        type: 'registry:example',
        path: 'src/demo/charts/bar-chart/bar-chart-minimal.tsx',
