...
export const audioRecorderRegistry = {
  ...
  'audio-recorder': {
    ...
    type: 'registry:ui',
    dependencies: ['expo-asset', 'expo-audio', 'lucide-react-native'],
    ...
    files: [
      {
        type: 'registry:ui',
        path: 'src/components/ui/audio-recorder.tsx',
        target: 'components/ui/audio-recorder.tsx',
      },
    ],
    preview: {
      light:
        'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0031-audio-recorder-demo.MP4',
      dark: 'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0031-audio-recorder-demo.MP4',
    },
  },
  ...
  'audio-recorder-demo': {
    ...
    files: [
      {
        type: 'registry:example',
        path: 'src/demo/audio-recorder/audio-recorder-demo.tsx',
  ...
  'audio-recorder-voice': {
    ...
    files: [
      {
        type: 'registry:example',
        path: 'src/demo/audio-recorder/audio-recorder-voice.tsx',
        target: 'components/demo/audio-recorder/audio-recorder-voice.tsx',
      },
    ],
    preview: {
      light:
        'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0032-audio-recorder-voice.MP4',
      dark: 'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0032-audio-recorder-voice.MP4',
    },
  },
  ...
  'audio-recorder-hq': {
    ...
    files: [
      {
        type: 'registry:example',
        path: 'src/demo/audio-recorder/audio-recorder-hq.tsx',
        target: 'components/demo/audio-recorder/audio-recorder-hq.tsx',
      },
    ],
    preview: {
      light:
        'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0033-audio-recorder-hq.MP4',
      dark: 'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0033-audio-recorder-hq.MP4',
    },
  },
  ...
  'audio-recorder-minimal': {
    ...
    files: [
      {
        type: 'registry:example',
        path: 'src/demo/audio-recorder/audio-recorder-minimal.tsx',
        target: 'components/demo/audio-recorder/audio-recorder-minimal.tsx',
      },
    ],
    preview: {
      light:
        'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0034-audio-recorder-minimal.MP4',
      dark: 'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0034-audio-recorder-minimal.MP4',
    },
  },
  ...
  'audio-recorder-styled': {
    ...
    files: [
      {
        type: 'registry:example',
        path: 'src/demo/audio-recorder/audio-recorder-styled.tsx',
        target: 'components/demo/audio-recorder/audio-recorder-styled.tsx',
      },
    ],
    preview: {
      light:
        'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0035-audio-recorder-styled.MP4',
      dark: 'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0035-audio-recorder-styled.MP4',
    },
  },
  ...
  'audio-recorder-callbacks': {
    ...
    files: [
      {
        type: 'registry:example',
        path: 'src/demo/audio-recorder/audio-recorder-callbacks.tsx',
        target: 'components/demo/audio-recorder/audio-recorder-callbacks.tsx',
      },
    ],
    preview: {
      light:
        'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0036-audio-recorder-callbacks.MP4',
      dark: 'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0036-audio-recorder-callbacks.MP4',
    },
  },
  ...
  'audio-recorder-cloud': {
    ...
    files: [
      {
        type: 'registry:example',
        path: 'src/demo/audio-recorder/audio-recorder-cloud.tsx',
        target: 'components/demo/audio-recorder/audio-recorder-cloud.tsx',
      },
    ],
    preview: {
      light:
        'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0037-audio-recorder-cloud.MP4',
      dark: 'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0037-audio-recorder-cloud.MP4',
    },
  },
  ...
  'audio-recorder-interview': {
    ...
    files: [
      {
        type: 'registry:example',
        path: 'src/demo/audio-recorder/audio-recorder-interview.tsx',
        target: 'components/demo/audio-recorder/audio-recorder-interview.tsx',
      },
    ],
    preview: {
      light:
        'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0038-audio-recorder-interview.MP4',
      dark: 'https://cdn.jsdelivr.net/gh/ahmedbna/bna-ui-demo/0038-audio-recorder-interview.MP4',
    },
  },
};
