 ...
 *
 * These are what `bna-ui add <name>` fetches at runtime. Serving them as static
 * assets (rather than a route handler) keeps them on the CDN with no function
 * invocations, and makes `/r/button.json` cacheable and independently
 * inspectable.
 *
