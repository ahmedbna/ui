...
A five-step spacing scale for margins, padding, and gaps.

| Key  | Value | Description                             |
| ---- | ----- | --------------------------------------- |
| `xs` | `4`   | Tight spacing, icon gaps                |
| `sm` | `8`   | Compact spacing between related content |
| `md` | `16`  | Default spacing between elements        |
| `lg` | `24`  | Section-level spacing                   |
| `xl` | `32`  | Large layout spacing                    |
