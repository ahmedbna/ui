...
<Callout title='Not shipped in either starter'>
  Neither the plain nor the auth starter uses Convex file storage — there is
  no avatar upload or file-picker screen to copy from. This page is a
  reference for adding it yourself, in the same style as the rest of your
