...
```bash
npx bna-ui@latest add [component]
```
...
```bash
npx bna-ui@latest init --template expo --typescript
```

### Add a button component

```bash
npx bna-ui@latest add button
```

### Add multiple components

```bash
npx bna-ui@latest add button input card
```

### Add all components

```bash
npx bna-ui@latest add --all
```

### Add component with platform-specific implementations

```bash
npx bna-ui@latest add button --ios --android
```
...
```bash
npx bna-ui@latest build --platforms ios,android
```
...
```bash
npx bna-ui@latest diff [component]
```
