...
<ComponentSource name='useThemeColor' title='hooks/useThemeColor.ts' />
...
- [`useTheme`](/docs/hooks/use-theme) - More comprehensive theme management
- [`useThemedStyles`](/docs/hooks/use-themed-styles) - For complex style calculations
